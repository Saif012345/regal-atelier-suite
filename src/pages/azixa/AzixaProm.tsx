...
const promDresses = [
  ...
  { id: "midnight-serenade", name: "Midnight Serenade", image: categoryProm },
  { id: "rose-gold-dream", name: "Rose Gold Dream", image: categoryProm },
  { id: "enchanted-evening", name: "Enchanted Evening", image: categoryProm },
];
      ...
      <section className="bg-gradient-hero py-16">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-muted-foreground max-w-2xl mx-auto mb-8">
            Make your prom night unforgettable with a custom-designed gown that captures 
