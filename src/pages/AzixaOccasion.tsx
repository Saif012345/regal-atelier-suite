...
export default function AzixaOccasion() {
  ...
  // Fetch occasion products from database
  const { data: products, isLoading } = useProducts("azixa", "Occasion");
      ...
      <section className="bg-gradient-hero py-16">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-muted-foreground max-w-2xl mx-auto mb-6">
            Sophisticated gowns for galas, events, and special celebrations. 
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          {isLoading ? (
            ...
            <div className="text-center py-16">
              <p className="text-lg text-muted-foreground">No occasion wear available yet.</p>
              <Link to="/custom-inquiry">
